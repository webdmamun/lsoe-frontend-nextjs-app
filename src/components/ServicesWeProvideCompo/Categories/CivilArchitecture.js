    ...
    <div className="hero bg-base-100 py-10">
      <div className="hero-content flex-col lg:flex-row-reverse shadow-xl px-20 rounded-xl">
        ...
        <div className="lg:pr-10">
          ...
          <ul className="py-10">
            <li className="list-disc list-inside">Mason (Plaster, Block)</li>
            <li className="list-disc list-inside">Mason (Tiles)</li>
            <li className="list-disc list-inside">Rod Binder (Steel Fixer)</li>
            <li className="list-disc list-inside">Shuttering Carpenter</li>
            <li className="list-disc list-inside">
              Plumbing (Pipe Fitting Sanitary Work)
            </li>
            <li className="list-disc list-inside">Aluminum Fabrication</li>
            <li className="list-disc list-inside">Gypsum Ceiling</li>
            <li className="list-disc list-inside">Labor</li>
          </ul>
...
export default CivilArchitecture;
