    ...
    <>
      <div className="hero bg-base-100 py-10">
        <div className="hero-content flex-col lg:flex-row-reverse shadow-xl px-20 rounded-xl">
          <img
            src="https://res.cloudinary.com/lsoe/image/upload/v1675794315/images/healthCare_y05jbl.png"
            alt=""
          ...
          <div className="lg:pr-10">
            ...
            <ul className="py-10">
              <li className="list-disc list-inside">Care Support Worker</li>
              <li className="list-disc list-inside">Nurse</li>
              <li className="list-disc list-inside">Pharmacist</li>
            </ul>
