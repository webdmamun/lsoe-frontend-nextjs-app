    ...
    <>
      <footer className="footer lg:grid-cols-3 lg:justify-items-center p-10 bg-base-100 text-base-content">
        ...
        <div>
          ...
          <img
            src="https://res.cloudinary.com/lsoe/image/upload/v1680119517/images/BrightHR_abpmi6.png"
            alt="Logo"
            className="w-60 mb-3"
          />
        </div>
        ...
        <div>
          ...
          <h6>
            ...
            20 Ashley Road, Leeds, England, LS9 7AJ
          </h6>
          <h6>
          ...
          <h6>
            ...
            <a href="mailto:info@lsoe.org.uk">info@lsoe.org.uk</a>
          </h6>
        </div>
      </footer>
...
export default EmploymentFooter;
