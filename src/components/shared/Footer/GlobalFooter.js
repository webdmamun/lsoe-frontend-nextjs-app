      ...
      <footer className="footer lg:grid-cols-3 lg:justify-items-center p-10 bg-base-100 text-base-content">
        <div className="grid-cols-1">
          <Link href="/">
            <ReactSVG
              className="w-60 mb-3"
              src="https://media.londonschoolofexcellence.com/lsoe-website-images/LSOE_Logo_White.svg"
            />
          </Link>
        ...
        <div>
          <span className="footer-title">More about LSOE</span>
          <Link href="/about-us" className="link link-hover">
            About Admission Hub
          </Link>
          <Link href="/about-employment-hub" className="link link-hover">
            About Employment Hub
          </Link>
          <Link href="/contact-us" className="link link-hover">
            Contact Admission Hub
          </Link>
          <Link
            href="/contact-london-source-of-employment"
            className="link link-hover"
          >
            Contact Employment Hub
          </Link>
        </div>
        <div>
        ...
        <div>
          <span className="footer-title">LOSE Pvt. Ltd.</span>
          <h6>
            <i className="fas fa-map-marker-alt footer-icon mx-2"></i>5 Station
            Parade, Hornchurch, Elm Park, London, RM12 5AB
          </h6>
          <h6>
            <i className="fas fa-map-marker-alt footer-icon mx-2"></i>5th - 18th
            Floors, 67 Albion Street Pinnacle, Leeds, LS1 5AA
          </h6>
          <h6>
      ...
      <footer className="footer px-10 py-4 border-t bg-base-100 text-base-content border-base-300">
        ...
        <div className="md:place-self-center md:justify-self-end">
          <div className="grid grid-flow-col gap-4">
            ...
            <a
              href="https://www.tiktok.com/@londonschoolofexcellence"
              target="_blank"
              rel="noreferrer"
            >
              <svg
            ...
            <a
              href="https://www.instagram.com/lsoe.ltd/"
              target="_blank"
              rel="noreferrer"
            >
              <svg
