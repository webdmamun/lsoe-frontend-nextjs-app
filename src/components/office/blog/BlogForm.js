...
import { getAutoGeneratedSlugUpdate, getSubmitSlug } from '@/lib/blog/blogSlugState.mjs';
...
export default function BlogForm({
  ...
  useEffect(() => {
    setForm((prev) => getAutoGeneratedSlugUpdate(prev, isSlugEdited, slugify));
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      await onSubmit({
        ...form,
        slug: getSubmitSlug(form, isSlugEdited, slugify),
