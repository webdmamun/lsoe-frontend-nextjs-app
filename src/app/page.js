...
export const metadata = {
  ...
  openGraph: {
    ...
    url: '/',
    images: [{ url: '/og-image.png', width: 1024, height: 1024, alt: 'London School of Excellence' }],
  },
  twitter: {
...
function SeoPathwaysSupport() {
  const links = [
    ...
    {
      title: 'UK Admissions Blog',
      desc: 'Student finance, UCAS tips, visa guides, and more.',
      href: '/blog',
    },
  ];
